...
In Integration Gateway, open the **Run History** and click on the most recent entry, then click on _INPUT_ in the Steps column.&#x20;
...
In Integration Gateway, navigate to the **Build page**_**,**_ select our integration, right-click, and _Go To > Service Request_.
