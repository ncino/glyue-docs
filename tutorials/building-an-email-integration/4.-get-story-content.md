...
Integration Gateway will execute a SR once for every item in its **Call For Each**. Using python lists is the most common.
...
{% hint style="success" %}
Our Integration Gateway integration has now made 11 requests to an external API, with 10 of them being done in a programmatic fashion. Nice Job!
{% endhint %}
