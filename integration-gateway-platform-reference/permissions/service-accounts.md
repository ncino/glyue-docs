...
Service Accounts are intended to manage third-party system access to Integration Gateway integrations. Service Accounts cannot:

* Log into Integration Gateway
* View or modify integrations
* Invite users to Integration Gateway
