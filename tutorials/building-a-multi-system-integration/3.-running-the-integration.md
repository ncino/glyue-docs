...
Return to Integration Gateway, right click on our integration, and click _Run Integration._ Click _Execute_ on the **Integration Runner**. Verify that the integration ran successfully. Check the output of the integration and remember the name of the new user.
