...
## v4.8.0 - September 17th, 2024

- Introducing the built-in [Glyue Idempotency Layer](../integration-gateway-platform-reference/idempotency-layer), making idempotency protection available to all integrations.
...
- Glyue Admins now have the ability to set a default permissions group for new [regular (non-staff) users](../integration-gateway-platform-reference/permissions#user-type).
- Glyue now supports the [OAuth 2.0 Client Credentials](../integration-gateway-platform-reference/authentication#oauth-2.0-client-credentials) authentication flow (“browserless OAuth”) for more flexible authentication patterns across our support systems.
