...
Integration Gateway integrations are exposed via their URL. We need to make two changes to our integration to prepare it for external calls. Start by navigating to the **Build page,** right-clicking on the integration, and selecting _Configure_.
